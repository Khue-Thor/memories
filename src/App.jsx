  ...
  const contracts = [
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "verified",
        imageUrl:
          "https://i.seadn.io/gcs/files/ff62dd4e9b27dee15e7ac89307a917b5.png?w=500&auto=format",
        description:
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "verified",
        imageUrl:
          "https://i.seadn.io/gae/Mf4vImKbzrJUcj7f7RZNOl9iZSEEJgkvpiUp9ugXc9dcpxFe6fvVgxYcRmTI1PnvfL_X1bD3mH4e66j6aJhqLEYm0vvpC8Jy8XJNZOI?w=500&auto=format",
        description:
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "verified",
        imageUrl:
          "https://i.seadn.io/gcs/files/219eccd44085d56b9a9c822b4eae3156.jpg?w=500&auto=format",
        description:
          "AIPES is the culture shift bridging AI and the Blockchain. A strong and sustainable brand built through unique mechanism to strengthen the AIPES collection. AI Artworks inspired by BAYC & MAYC. Let the art do the speaking. Join the biggest AI NFT community. WE are waiting.",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        imageUrl:
          "https://i.seadn.io/gae/S7Z1XXStTUpCQkla-tmXLv8jwJPlWLMeUL_FtjCWS5Vjwl5C7xaUb0K3HoMmnnBulFpsjXFSjtK8YXURMtUYY3e6hJV27lVatlpC3g?w=500&auto=format",
        description:
          "Bored Ape Comic #2 is out now.  Issues consists of 10,000 NFTs & features a cast of Bored Apes. Visit https://boredapecomic.com for more details.",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gae/_aGEv4qZuGOsSyiaOWsg8suTiSdbRYIIvcBWxtx0PMc0PejgbfxMosmoH_2tpxm_bs_oIb8dTpIT9sr0-yv599HF4KJfdzA7PSVwuQ?w=500&auto=format",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/46238735831a3e1a64a7cbd9f3b07fa7.png?w=500&auto=format",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/dfaa6b5e403076849c43a2a8784697ca.png?w=500&auto=format",
        description:
          "Bored Ape Yoga Club is a 10,000-piece NFT collection on the Ethereum blockchain that began as parody in the form of five memes drawn by the artist, first of BAYC #2613 and then of the Yuga Labs founders’ BAYCs assuming the now infamous ape yoga position.\r\n\r\nAs the images quickly spread throughout the crypto community on Twitter, demand for a complete 10k NFT collection of bored apes practicing throat yoga grew organically to a point that the artist was compelled to capture this sentiment permanently on-chain in full parity with the Bored Ape Yacht Club NFTs.",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/569fa5fbb1e674c9c2be544097b5e450.gif?w=500&auto=format",
        description:
          "Something odd emerged from the Swamp, raising the curiosity of an Ape living close by. He took them home, only to see them run away over night. Since then, they’ve grown eyes, mouth, arms and started wearing clothes. What the hell are they? What do they want? Ape can’t contain his curiosity and organizes an expedition to capture all 10.000 of them.",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gae/2NaECQ6t2NxgNX2LFAN6l8ELPGYUQ14nCgc-8fIzzZLkThzGoHsT-vO32YhxgujlF0ZJxd9helW1hr77y4rNHow6B6rT8GzT5riDtQ?w=500&auto=format",
        description:
          "The Bored.Ai Collective is dedicated to giving its members creative superpowers, beginning with a collection of 10,000 MemberChips - NFTs which grant access to cutting-edge artificial intelligence (Ai). Your MemberChip NFT doubles as your ticket to the Bored.Ai Collective, and gets you exclusive access to members-only spaces and perks, and NFT drops - the first of which is the debut [Text2Art collection](https://opensea.io/collection/bored-ai-text2art) | Visit our [website](https://bored.ai) for more information | [Bored.Ai Disk @ OpenSea](https://opensea.io/collection/bored-ai-disk)",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/bcde851a159ba45d9a2fb2a8065c6d20.gif?w=500&auto=format",
        description: "",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gae/8ZggCNMQiAoVbPKc46to1Q0eTKwfiQCsAUUczltGLmBX-O33-_ke_lWRbL6o3RqfCbq1g1Yk-3TR_KtI_4W5Af_RKwD1Kg_lCLeC?w=500&auto=format",
        description:
          "Basic Bored Ape Club / BBAC\n\nNFT collection inspired by an existing and truly admired collection,\nbut completely independent and unaffiliated.",
        externalUrl: null,
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gae/jo2dgEbi-mgUuJyVvsEHr5dSGf8LaBcjLWuHWoAxeZ0KGAvMrYToT1-W6CBkltBfZN8pdfSQ1VzHhbcr_dFFbjcBWRCyVyqSKqqJqg?w=500&auto=format",
        description:
          "The OG Collection for the Origin Story of American Ape (BAYC #5636).  This series documents the journey of the American Ape as he searches for the Bored Ape Yacht Club. Accept no substitutes, but the series continues in a new contract [HERE] (https://opensea.io/collection/american-ape-digital-comics).\n\nThis ERC-721 token will be required to claim a physical graphic novel when the series goes to print.  Holders of 20 or more will occasionally have the ability to burn them for a Custom Cover, when the waitlist opens in the Myth Division Discord.",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/1c6d3c3c829315d38c2b2068a52f5d02.jpg?w=500&auto=format",
        description:
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        imageUrl:
          "https://i.seadn.io/gae/dpHCrlverfVuJMixZvOqKlOznhnAc9qMC7ewgeLvSv4deBwXizck72INJFLdzjipaNLD1j8exBiwFYcTWkf04B2nSswY5EFwEtZSh8s?w=500&auto=format",
        description:
          "Bored Bunny is a collection of 4999 unique 3D well-designed Bunnies - Sold out in 17 minutes.\r\nFloyd Mayweather, DJ Khaled, David Dobrik, Umar Kamani, Chantel Jeffries and many more celebrities have already joined the project.\r\n\r\nEvery Bored Bunny holder will receive a Bored Bad Bunny (our next collection) for free",
    ...
    },
    {
      ...
      openSeaMetadata: {
        ...
        safelistRequestStatus: "approved",
        imageUrl:
          "https://i.seadn.io/gcs/files/d8282a1490e4e046be1f7dbe5cc2d3f5.gif?w=500&auto=format",
        description:
          "10'000 unique NFT watches inspired by every trait and rarity of the most famous NFT collection to date\nNO DISCORD NO ROADMAP NO WASTE OF TIME\nNot affiliated with Yuga Labs.\nFrom the same creators of https://twitter.com/DwissWatch",
        externalUrl: null,
